    ...
    static ProcessFileWithAnalysis(filePath: string): FileAnalysisResult {
        try {
            ...
            const metadata: FileMetadata = {
                ...
                markdownHeadings: MarkdownHeadingExtractor.extractFromContent(markdownContent),
                leafMarkdownHeadings: [],
            };
            metadata.leafMarkdownHeadings = MarkdownHeadingExtractor.extractLeafMarkdownHeadingsPath(metadata.markdownHeadings);
